...
public class DataFlowPathWeight extends Weight{
	...
	/**
	 * A subset of {@link #allStatements} that lists only the last usage of a variable.
	 * When data-flow at branches is joined, the set can contain multiple statement that use the variable 
	 */
