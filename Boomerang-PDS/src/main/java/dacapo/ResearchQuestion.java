  ...
  private void benchLoad() throws IOException {
    ...
    if (benchmarkName == null)
      throw new RuntimeException(
          "Set property -Dbenchmark= as VM argument to select the benchmark");
    String propFileName =
        System.getProperty("benchmarkFolder") + benchmarkName + "/" + benchmarkName + ".properties";
...
//    Options.v().set_include_all(true);
    ...
    if (!Boolean.parseBoolean(System.getProperty("library"))) {
      Options.v().set_main_class(this.getMainClass());
      Options.v().setPhaseOption("cg.spark","on,simulate-natives:true");
    } else {
      Options.v().set_exclude(new LinkedList<String>(Collections.singleton("sun.reflect")));
      Options.v().setPhaseOption("cg", "library:signature-resolution");
      Options.v().setPhaseOption("cg.spark", "on,vta:true");
    }
//    readDynamicClasses();
...
//    Scene.v()
  ...
  private void readDynamicClasses() {
    ...
    String line;
    String propFileName = benchmarkName +".dyn";
  ...
  private String prependBasePath(String jar) {
    ...
    if (path == null)
      throw new RuntimeException(
"Set property -DdacapoPath= as VM argument");
    return path + jar;
  }
